...
/**
 * 题目： 2 个字符串，字符串 A，字符串 B；其中，字符串 B 是字符串 A的子串，求最短子串的长度
 *
 * 参考：
 * 1. http://blog.csdn.net/yahohi/article/details/7906833
 * 2. http://www.itkeyword.com/doc/5081124796463311668/java-
 *
 */
public class TwoStringShortestSubStringLength {
