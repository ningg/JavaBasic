package top.ningg.java.mobike.ridingtrack;
 ...
 * 骑行轨迹的坐标点。
 */
public class RidingTrackPoint implements Serializable {

    private static final long serialVersionUID = 2884577850552961029L;
